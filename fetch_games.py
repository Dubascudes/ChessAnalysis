...
DB_FILE = "deepcroaker_games.db"
USERNAME = "deepcroaker"  # API path is case-sensitive; use lowercase here
API_URL_TEMPLATE = (
    "https://api.chess.com/pub/player/{username}/games/{year}/{month:02d}/pgn"
)
DEFAULT_USER = "deepcroaker"

# A proper User-Agent and Accept header to avoid 403
HEADERS = {
    "User-Agent": "DeepcroakerGameDB/1.0 (will.english@ufl.edu)",
...
def fetch_current_month_games(username: str = "deepcroaker") -> list[dict]:
    """
